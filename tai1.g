...
G1 X0.85 F500 ; start at the left edge of copper
M106 ; turn on green resist extruder (and fan)
G1 Y3 F200 ; do the left y run
G1 Y12 F500 ; do the left y run
G1 X11.0 F500 ; do the x run
G1 Y-12 F500 ; do the right -y run MINUS 3
M107 ; turn off green resist extruder (and fan)
G1 Y-3 X0.5 F500 ; do the right -y run LAST 3 + RIGHT 0.5
G1 Z5 F100 ; move up 5 SLOWLY
G1 Z5 F1000 ; move up 5
G1 X-12.35 F500 ; move to left near corner + LEFT 0.5 + to edge of copper
